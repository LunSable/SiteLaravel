            ...
            <div class="container clearfix">
                ...
                <div class="books_title clearfix">
                    ...
                    <div class="admin_block">
                        <form action="/submit/add" class="form_admin_add" method="post">
                            @csrf
                            <div class="name_field admin_field">Название книги:</div>
                            <input type="text" class="name_input admin_text" name="book">
                            <div class="author_field admin_field">Автор книги:</div>
                            <select class="author_input admin_text" name="idAuthor" >
                            ...
                            <input type="text" class="type_input admin_text" name="type">
                            <div class="sum_field admin_field">Кол-во книг:</div>
                            <input type="number" class="sum_input admin_text" name="sum">
                            <br>
