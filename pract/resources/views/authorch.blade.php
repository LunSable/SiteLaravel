                ...
                <aside class="sidebar">
                    <nav class="sidebar_nav">
                        <ul class="sidebar_list">
                            ...
                            <li class="sidebar_item">
                                <a href="/author" class="sidebar_link sidebar_link_active">
                                    ...
                                    <div class="shadow_block">
                                        ...
                                        <div class="books_block_text">
                                            <div class="books_block_padding">
                                                <div class="books_block_name">{{$author->name_author}}</div>
                                                <div class="books_block_title"></div>
                                                <div class="books_block_work">
                                                    <i class="fa fa-book" aria-hidden="true"></i>
                                                    <div class="books_block_workname">Количество книг:{{$author->book->count()}}</div>
                                                <div class="books_block_work_right">
                                                        <i class="fas fa-exchange-alt"></i>
                                                        <a href="{{route('author-change', $author->id)}}" class="admin_link link_ch">Редактировать</a>
                                                    </div>
                                                    <div class="books_block_work_right">
                                                        <i class="fas fa-trash"></i>
                                                        <a href="{{route('author-delete', $author->id)}}" class="admin_link link_ch">Удалить</a>
                                                </div>
                                                </div>
