                    ...
                    <nav class="sidebar_nav">
                        <ul class="sidebar_list">
                            <li class="sidebar_item">
                                <a href="/" class="sidebar_link sidebar_link_active">
                                    ...
                                    <div class="shadow_block">
                                        ...
                                        <div class="books_block_text">
                                            <div class="books_block_padding">
                                                <div class="books_block_name">{{$bookk->name_books}}</div>
                                                <div class="books_block_title">{{$bookk->type_books}}</div>
                                                <div class="books_block_work clearfix">
                                                    <div class="books_block_work_left">
                                                        <i class="fa fa-bookmark" aria-hidden="true"></i>
                                                        <div class="books_block_workname">{{$bookk->author->name_author}}</div>
                                                    </div>
                                                    <div class="books_block_work_right">
                                                        <i class="fas fa-exchange-alt"></i>
                                                        <a href="{{route('book-change', $bookk->id)}}" class="admin_link link_ch">Редактировать</a>
                                                    </div>
                                                    <div class="books_block_work_right">
                                                        <i class="fas fa-trash"></i>
                                                        <a href="{{route('book-delete', $bookk->id)}}" class="admin_link link_ch">Удалить</a>
                                                    </div>
                                                </div>
